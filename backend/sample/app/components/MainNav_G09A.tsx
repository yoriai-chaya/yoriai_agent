  ...
  return (
    <div data-testid="main-nav" className="hidden md:flex w-full">
      <nav className="grid grid-cols-3 w-full items-center gap-4">
        ...
        <div data-testid="main-navbar-title" className="text-center text-lg">ホテル東京</div>
        <div className="flex items-center justify-end gap-4">
          {pathname === "/" && (
            <Button className="bg-ctm-blue-500 hover:bg-ctm-blue-600" onClick={handleSearch} data-testid="main-navbar-button-booking">
