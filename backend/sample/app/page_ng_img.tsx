const Home = () => {
  return (
    <div>
      <img src="/hotel.png" alt="Hotel Image" className="w-full h-auto" />
      <h1 className="text-center text-lg px-8 pb-4">都会の静寂に包まれて、心ほどけるひとときを</h1>
      <div className="text-left text-sm px-8">
