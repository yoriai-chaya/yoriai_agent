          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col items-center">
                <p data-testid="checkin-title">チェックイン</p>
                <DatePicker date={checkInDate} setDate={setCheckInDate} name="check-in" />
              </div>
              <div className="flex flex-col items-center">
                <p data-testid="checkout-title">チェックアウト</p>
                <DatePicker date={checkOutDate} setDate={setCheckOutDate} name="check-out" />
              </div>
              <div className="flex flex-col items-center">
                <p className="mx-5 text-nowrap">人数</p>
                <Select value={guestCount} onValueChange={setGuestCount} data-testid="guest-select-trigger">
                  <SelectTrigger className="ring-0 focus-visible:ring-0 border-0 shadow-none">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
